...
class Category(MPTTModel):
    ...
    svg = models.FileField(blank=True, upload_to="cat_images", validators=[FileExtensionValidator(['pdf', 'doc', 'svg'])], verbose_name='تصویر SVG')
    ...
    def save(self, *args, **kwargs):
        self.slug = slugify(self.en_title, instance=self)
