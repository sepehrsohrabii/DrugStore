...
class OrderAdmin(admin.ModelAdmin):
    ...
    fields = (
        ...
        'amount', 'total_th', 'post_w', 'post_p', 'ip', 'total_products', 'total_products_takhfif', 'coupon', 'coupon_takhfif', 'total')
    readonly_fields = (
        'user_name', 'address_full_name', 'address_ostsn', 'address_city', 'address_address', 'amount', 'total_th',
        'post_w', 'post_p',
        'ip', 'total_products', 'total_products_takhfif', 'coupon', 'coupon_takhfif', 'total')
    can_delete = False
